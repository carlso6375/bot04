...
const vcard = 'BEGIN:VCARD\n'
            ...
            + 'FN:nabuto\n' // Nama kamu
            + 'ORG:Lexa;\n' // Nama bot
            + 'TEL;type=CELL;type=VOICE;waid=558881321692:55 88 8132-1692\n' //Nomor whatsapp kamu
            + 'END:VCARD'
prefix = '/','*','.'
blocked = []
limitawal = '999999999'
		...
		try {
			...
			mess = {
				...
				only: {
					...
					userB: `──「 LISTA 」──\nOlá Kak !\nDesculpe, irmã. Você não está registrado como amigo de jc. Registre-se para fazer amizade com o bot Nabuto por meio, \n\nCommand : ${prefix}daftar nama|idade\nExemplo : ${prefix}daftar nabuto|14\n\n──「 Nabuto BOT 」──`,
			...
			const ownerNumber = ["558881321692@s.whatsapp.net"] // replace this with your number
			const mod = [ownerNumber,"+19255948027@s.whatsapp.net"]//ubah nomor lo
			const adminbotnumber = ["+19255948027@s.whatsapp.net"]//ubah nomor lo
			const frendsowner = ["+19255948027@s.whatsapp.net"]//ubah nomor lo
			const premium = ["558881321692@s.whatsapp.net","558881202856@s.whatsapp.net","558881840061@s.whatsapp.net","558881995263@s.whatsapp.net","558881321692@s.whatsapp.net","554792091566@s.whatsapp.net","558699541889@s.whatsapp.net","559294313229@s.whatsapp.net","554298653614@s.whatsapp.net"]
...
if (text.includes("placa"))
  ...
  conn.sendMessage(id, hasil, MessageType.text); 
		...
		if (isGroupAdmins) return reply('pow cara, não fale essas coisas só pq vc é adm, isso pode ofender alguém e fazer a pessoa ficar em depression😣')
	...
	if (messagesC.includes("fdp")){
			client.updatePresence(from, Presence.composing)
			reply("meu pau te cutuca")
				}
	
	if (messagesC.includes("bosta")){
			client.updatePresence(from, Presence.composing)
			reply("quer q eu soque sua bosta?😔")
	}
		...
		if (messagesC.includes("gostoso")){
			client.updatePresence(from, Presence.composing)
			reply("unico gostoso aq é, o Carlão pau de touro")
	}
	...
	if (messagesC.includes("manel")){
			client.updatePresence(from, Presence.composing)
			reply("o famoso chora no pau 😈")
	}
	
	if (messagesC.includes("kayky")){
			client.updatePresence(from, Presence.composing)
			reply("Carlão vive te pau dentro")
	}
	
	if (messagesC.includes("carlos")){
			client.updatePresence(from, Presence.composing)
			reply("comedor de casada😐🤙")
	}
		...
		case 'bpfont':
           ...
           case 'playmp3':
            ...
            case 'smule':
				...
				break
                case 'shitpost':
				 data = fs.readFileSync('./src/shitpost.js');
                 jsonData = JSON.parse(data);
                 randIndex = Math.floor(Math.random() * jsonData.length);
                 randKey = jsonData[randIndex];
                hasil = await getBuffer(randKey.result)
                sendImage(hasil, mek, '*shitpost :V*')
				break									
         case 'moddroid':
...
break
case 'azul':
tujuh = fs.readFileSync('./assets/azul.mp3');
client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'tapa':
tujuh = fs.readFileSync('./assets/tapa.mp3');
client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'lifestyle':
tujuh = fs.readFileSync('./assets/lifestyle.mp3');
client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'a':
...
break
case 'carlos':
tujuh = fs.readFileSync('./assets/carlos.mp4');
client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'shit1':
tujuh = fs.readFileSync('./assets/shit1.mp4');
client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'shit2':
tujuh = fs.readFileSync('./assets/shit2.mp4');
client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'shit3':
tujuh = fs.readFileSync('./assets/shit3.mp4');
client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'beat2':
...
// recursos anime, random @nabuto domina vida
          ...
          reply('Espere..')
			    ...
			    case 'dono':
                    ...
                    client.sendMessage(from, 'Meu dono é esse gasoso aí tal de "carlos"🙄, chama ele aí ele diz que é "Shitpost"',MessageType.text, { quoted: mek} )
                    break
                case 'fitnah':	
				case 'fake':          
                    if (!isGroup) return reply(mess.only.group)
